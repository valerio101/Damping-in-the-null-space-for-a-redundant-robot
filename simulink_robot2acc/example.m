...
exportgraphics(f2, base_path + base_name1 + base_name2 + base_name3 + "_acc.pdf");
exportgraphics(f3, base_path + base_name1 + base_name2 + base_name3 + "_cart_err.pdf");
exportgraphics(f4, base_path + base_name1 + base_name2 + base_name3 + "_dq.pdf");
exportgraphics(f5, base_path + base_name1 + base_name2 + base_name3 + "_cart_pos.pdf");