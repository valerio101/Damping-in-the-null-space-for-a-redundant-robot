#ifndef __zlVsX1SxkEh1WoTDwpn32F_h__
#define __zlVsX1SxkEh1WoTDwpn32F_h__
...
#ifndef struct_tag_OYtNg07EMEPBk2palUwBGE
#define struct_tag_OYtNg07EMEPBk2palUwBGE

struct tag_OYtNg07EMEPBk2palUwBGE
{
  boolean_T f1;
  boolean_T f2;
  boolean_T f3;
...
#endif                                 /* struct_tag_OYtNg07EMEPBk2palUwBGE */

#ifndef typedef_s_OYtNg07EMEPBk2palUwBGE
#define typedef_s_OYtNg07EMEPBk2palUwBGE

typedef struct tag_OYtNg07EMEPBk2palUwBGE s_OYtNg07EMEPBk2palUwBGE;

#endif                                 /* typedef_s_OYtNg07EMEPBk2palUwBGE */
...
typedef struct tag_1rRlHW44Di0Fe0KbG1JvIG
  robotics_manip_internal_CollisionGeometry;

#endif                                 /* typedef_robotics_manip_internal_CollisionGeometry */

#ifndef struct_coder_array_tag_1rRlHW44Di0Fe0K
#define struct_coder_array_tag_1rRlHW44Di0Fe0K

struct coder_array_tag_1rRlHW44Di0Fe0K
{
  struct {
...
#endif                                 /* struct_coder_array_tag_1rRlHW44Di0Fe0K */

#ifndef typedef_coder_array_robotics_manip_inte
#define typedef_coder_array_robotics_manip_inte

typedef struct coder_array_tag_1rRlHW44Di0Fe0K coder_array_robotics_manip_inte;
...
typedef struct tag_EF7TXrGttbvnV740WJJROG robotics_manip_internal_CollisionSet;

#endif                                 /* typedef_robotics_manip_internal_CollisionSet */

#ifndef struct_tag_aEgpLWeWOTmUKYQEzWNt1D
#define struct_tag_aEgpLWeWOTmUKYQEzWNt1D

struct tag_aEgpLWeWOTmUKYQEzWNt1D
{
  s_OYtNg07EMEPBk2palUwBGE _data;
};

#endif                                 /* struct_tag_aEgpLWeWOTmUKYQEzWNt1D */

#ifndef typedef_s_aEgpLWeWOTmUKYQEzWNt1D
#define typedef_s_aEgpLWeWOTmUKYQEzWNt1D

typedef struct tag_aEgpLWeWOTmUKYQEzWNt1D s_aEgpLWeWOTmUKYQEzWNt1D;

#endif                                 /* typedef_s_aEgpLWeWOTmUKYQEzWNt1D */
...
#ifndef struct_tag_nAbd9HlQcMb4tQTn7JxqPD
#define struct_tag_nAbd9HlQcMb4tQTn7JxqPD

struct tag_nAbd9HlQcMb4tQTn7JxqPD
{
  real_T Length;
  char_T Vector[200];
};

#endif                                 /* struct_tag_nAbd9HlQcMb4tQTn7JxqPD */

#ifndef typedef_robotics_manip_internal_CharacterVector
#define typedef_robotics_manip_internal_CharacterVector

typedef struct tag_nAbd9HlQcMb4tQTn7JxqPD
  robotics_manip_internal_CharacterVector;

#endif                                 /* typedef_robotics_manip_internal_CharacterVector */

#ifndef struct_tag_IMjqh0KO0285DPkSISJMnD
#define struct_tag_IMjqh0KO0285DPkSISJMnD

struct tag_IMjqh0KO0285DPkSISJMnD
{
...
#endif                                 /* struct_tag_IMjqh0KO0285DPkSISJMnD */

#ifndef typedef_rigidBodyJoint
#define typedef_rigidBodyJoint

typedef struct tag_IMjqh0KO0285DPkSISJMnD rigidBodyJoint;

#endif                                 /* typedef_rigidBodyJoint */

#ifndef struct_tag_u2iWr55i9yjy8Qv7LxhYhG
#define struct_tag_u2iWr55i9yjy8Qv7LxhYhG

struct tag_u2iWr55i9yjy8Qv7LxhYhG
{
  boolean_T matlabCodegenIsDeleted;
  robotics_manip_internal_CharacterVector NameInternal;
  real_T Index;
...
#endif                                 /* struct_tag_u2iWr55i9yjy8Qv7LxhYhG */

#ifndef typedef_robotics_manip_internal_RigidBody
#define typedef_robotics_manip_internal_RigidBody

typedef struct tag_u2iWr55i9yjy8Qv7LxhYhG robotics_manip_internal_RigidBody;

#endif                                 /* typedef_robotics_manip_internal_RigidBody */

#ifndef struct_tag_bIIm06gU3hugqmqWppjRLF
#define struct_tag_bIIm06gU3hugqmqWppjRLF

struct tag_bIIm06gU3hugqmqWppjRLF
{
  boolean_T matlabCodegenIsDeleted;
  real_T NumBodies;
...
#endif                                 /* struct_tag_bIIm06gU3hugqmqWppjRLF */

#ifndef typedef_robotics_manip_internal_RigidBodyTree
#define typedef_robotics_manip_internal_RigidBodyTree

typedef struct tag_bIIm06gU3hugqmqWppjRLF robotics_manip_internal_RigidBodyTree;

#endif                                 /* typedef_robotics_manip_internal_RigidBodyTree */

#ifndef struct_tag_PDEoXtCyoHuQnM81zktErD
#define struct_tag_PDEoXtCyoHuQnM81zktErD

struct tag_PDEoXtCyoHuQnM81zktErD
{
  boolean_T matlabCodegenIsDeleted;
...
#endif                                 /* struct_tag_PDEoXtCyoHuQnM81zktErD */

#ifndef typedef_robotics_slmanip_internal_block_ForwardDynamicsBlock
#define typedef_robotics_slmanip_internal_block_ForwardDynamicsBlock

typedef struct tag_PDEoXtCyoHuQnM81zktErD
  robotics_slmanip_internal_block_ForwardDynamicsBlock;

#endif                                 /* typedef_robotics_slmanip_internal_block_ForwardDynamicsBlock */

#ifndef struct_tag_s1GdXRYBhtqvgPZaZkb6s7C
#define struct_tag_s1GdXRYBhtqvgPZaZkb6s7C

struct tag_s1GdXRYBhtqvgPZaZkb6s7C
{
  uint8_T Type;
  real_T NameLength;
  uint8_T Name[15];
...
#endif                                 /* struct_tag_s1GdXRYBhtqvgPZaZkb6s7C */

#ifndef typedef_s1GdXRYBhtqvgPZaZkb6s7C
#define typedef_s1GdXRYBhtqvgPZaZkb6s7C

typedef struct tag_s1GdXRYBhtqvgPZaZkb6s7C s1GdXRYBhtqvgPZaZkb6s7C;

#endif                                 /* typedef_s1GdXRYBhtqvgPZaZkb6s7C */
...
#ifndef struct_tag_5dXKEjT4mY2464Whs2HBNC
#define struct_tag_5dXKEjT4mY2464Whs2HBNC

struct tag_5dXKEjT4mY2464Whs2HBNC
{
  real_T f1[2];
  real_T f2[2];
  real_T f3[2];
...
#endif                                 /* struct_tag_5dXKEjT4mY2464Whs2HBNC */

#ifndef typedef_s_5dXKEjT4mY2464Whs2HBNC
#define typedef_s_5dXKEjT4mY2464Whs2HBNC

typedef struct tag_5dXKEjT4mY2464Whs2HBNC s_5dXKEjT4mY2464Whs2HBNC;

#endif                                 /* typedef_s_5dXKEjT4mY2464Whs2HBNC */
...
#ifndef struct_tag_K7Re182KnosYTQUxwLdpcG
#define struct_tag_K7Re182KnosYTQUxwLdpcG

struct tag_K7Re182KnosYTQUxwLdpcG
{
  char_T f1[6];
  char_T f2[6];
  char_T f3[6];
...
#endif                                 /* struct_tag_K7Re182KnosYTQUxwLdpcG */

#ifndef typedef_s_K7Re182KnosYTQUxwLdpcG
#define typedef_s_K7Re182KnosYTQUxwLdpcG

typedef struct tag_K7Re182KnosYTQUxwLdpcG s_K7Re182KnosYTQUxwLdpcG;

#endif                                 /* typedef_s_K7Re182KnosYTQUxwLdpcG */
...
typedef struct tag_ge1UD3YqHcNerzgtJ4AjXF b_cell_wrap;
...
typedef struct tag_QUrJGLT4DsCLhnuPIs5e8F c_cell_wrap;
...
typedef struct tag_tz3atwCHJZXtFLBnil52jC h_cell;
...
#ifndef struct_tag_TJqa22L1B9tYMDavnd4uUG
#define struct_tag_TJqa22L1B9tYMDavnd4uUG

struct tag_TJqa22L1B9tYMDavnd4uUG
{
  real_T NumBodies;
  real_T MaxNumBodies;
  real_T Gravity[3];
  ...
  s1GdXRYBhtqvgPZaZkb6s7C Joints[9];
};

#endif                                 /* struct_tag_TJqa22L1B9tYMDavnd4uUG */

#ifndef typedef_s_TJqa22L1B9tYMDavnd4uUG
#define typedef_s_TJqa22L1B9tYMDavnd4uUG

typedef struct tag_TJqa22L1B9tYMDavnd4uUG s_TJqa22L1B9tYMDavnd4uUG;

#endif                                 /* typedef_s_TJqa22L1B9tYMDavnd4uUG */

#ifndef struct_tag_iNuMYMJ5vhWhDvmvRoxRTD
#define struct_tag_iNuMYMJ5vhWhDvmvRoxRTD

struct tag_iNuMYMJ5vhWhDvmvRoxRTD
{
  s_5dXKEjT4mY2464Whs2HBNC _data;
};

#endif                                 /* struct_tag_iNuMYMJ5vhWhDvmvRoxRTD */

#ifndef typedef_s_iNuMYMJ5vhWhDvmvRoxRTD
#define typedef_s_iNuMYMJ5vhWhDvmvRoxRTD

typedef struct tag_iNuMYMJ5vhWhDvmvRoxRTD s_iNuMYMJ5vhWhDvmvRoxRTD;

#endif                                 /* typedef_s_iNuMYMJ5vhWhDvmvRoxRTD */
...
#ifndef struct_tag_KyzrRw2gHLsI17g0hoIPSC
#define struct_tag_KyzrRw2gHLsI17g0hoIPSC

struct tag_KyzrRw2gHLsI17g0hoIPSC
{
  s_K7Re182KnosYTQUxwLdpcG _data;
};

#endif                                 /* struct_tag_KyzrRw2gHLsI17g0hoIPSC */

#ifndef typedef_s_KyzrRw2gHLsI17g0hoIPSC
#define typedef_s_KyzrRw2gHLsI17g0hoIPSC

typedef struct tag_KyzrRw2gHLsI17g0hoIPSC s_KyzrRw2gHLsI17g0hoIPSC;

#endif                                 /* typedef_s_KyzrRw2gHLsI17g0hoIPSC */
...
#ifndef typedef_InstanceStruct_zlVsX1SxkEh1WoTDwpn32F
#define typedef_InstanceStruct_zlVsX1SxkEh1WoTDwpn32F

typedef struct {
  SimStruct *S;
  robotics_slmanip_internal_block_ForwardDynamicsBlock sysobj;
...
#endif                                 /* typedef_InstanceStruct_zlVsX1SxkEh1WoTDwpn32F */
...
extern void method_dispatcher_zlVsX1SxkEh1WoTDwpn32F(SimStruct *S, int_T method,
  void* data);
